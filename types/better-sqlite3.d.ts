declare module "better-sqlite3" {
  namespace Database {
    ...
    interface Database { pragma(value: string): unknown; exec(sql: string): void; prepare(sql: string): Statement; transaction<T extends (...args: never[]) => unknown>(fn: T): T; backup(destinationFile: string): Promise<unknown>; close(): void; }
  }
